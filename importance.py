...
import json
import cv2  
from dataset import AngleDataNight 
...
train_pcd = "/media/parvez/Expansion/night/pcd" 
train_camera = "/media/parvez/Expansion/night/image" 
angle_path = "/media/parvez/Expansion/night/angle/angle.json"


train_dataset = AngleDataNight(pcd_path=train_pcd, camera_path=train_camera, angle_path=angle_path)
